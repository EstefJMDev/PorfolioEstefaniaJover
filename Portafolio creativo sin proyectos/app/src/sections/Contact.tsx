      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-slate-400 max-w-2xl mx-auto">
            ¿Tienes una idea en mente? Estoy disponible para nuevos proyectos 
            y colaboraciones. ¡Envíame un mensaje!
          </p>
        </motion.div>
          ...
          >
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="text-[#7FFFD4] font-medium">Disponible para proyectos</span>
              </div>
              <p className="text-sm text-slate-400">
                Actualmente estoy aceptando nuevos proyectos y colaboraciones. 
